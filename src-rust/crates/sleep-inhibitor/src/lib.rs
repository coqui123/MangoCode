...
impl SleepInhibitor {
    ...
    /// Replace the configured enabled state and re-apply it to the current turn.
    pub fn set_enabled(&mut self, enabled: bool) {
        self.enabled = enabled;
        self.set_turn_running(self.turn_running);
    }
...
mod tests {
    ...
    #[test]
    fn sleep_inhibitor_can_toggle_enabled_while_running() {
