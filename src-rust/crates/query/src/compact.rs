// Auto-compact service for mangocode-query.
//
...
impl AutoCompactState {
    ...
    /// Returns `true` if the circuit breaker was just opened by this call.
                ...
                match block {
                    ...
                    ContentBlock::ToolResult {
                        ...
                        let result_text = match content {
                            ...
                            mangocode_core::types::ToolResultContent::Blocks(_) => {
        ...
        Err(e) => {
            ...
            if state.on_failure() {
                error!(
                    ...
                    "Auto-compact has been disabled for this session after {} consecutive failures. \
                     Context management may be degraded.",
...
pub fn snip_compact(
    ...
    keep_n_newest: usize,
) -> (Vec<mangocode_core::types::Message>, u64) {
    let total = messages.len();
