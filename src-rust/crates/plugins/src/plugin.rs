...
///
/// `mangocode-plugins` does NOT implement `mangocode_commands::SlashCommand` directly (that
/// would create a circular dependency).  Instead `mangocode-commands` wraps
