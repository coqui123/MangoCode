//! OpenAI Codex OAuth 2.0 PKCE flow for MangoCode.
//!
...
use mangocode_core::codex_oauth::{CODEX_CLIENT_ID, CODEX_AUTHORIZE_URL, CODEX_REDIRECT_URI, CODEX_SCOPES, CODEX_TOKEN_URL};
