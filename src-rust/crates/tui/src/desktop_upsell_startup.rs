...
/// Returns true when MangoCode Desktop is a supported platform option.
...
impl DesktopUpsellSelection {
    fn label(self) -> &'static str {
        match self {
            Self::Try => "Open in MangoCode Code Desktop",
            Self::NotNow => "Not now",
...
pub fn render_desktop_upsell_startup(
    ...
    let mut lines: Vec<Line> = vec![
        ...
        Line::from(vec![Span::styled(
            "Same MangoCode features with visual diffs, live app",
...
mod tests {
    ...
    fn desktop_upsell_render_smoke() {
        ...
        let rendered = buf
            ...
            .collect::<Vec<_>>()
            .join("");
        assert!(rendered.contains("MangoCode Code Desktop") || rendered.contains("visual diffs"));
    }
