...
impl ColorPalette {
    ...
    /// Default MangoCode theme — "Ripe Mango" crimson palette matching the mascot
    fn default_theme() -> Self {
        Self {
            error: Color::Rgb(255, 69, 58),            // Vivid red (#FF453A)
            success: Color::Rgb(76, 175, 80),          // Mango leaf green (#4CAF50)
            warning: Color::Rgb(255, 200, 61),         // Golden amber (#FFC83D)
            info: Color::Rgb(250, 114, 145),           // Light rose (#FA7291)
            action: Color::Rgb(226, 39, 92),           // Mascot rose-red (#E2275C)
            disabled: Color::Rgb(140, 115, 120),       // Warm rose-gray (#8C7378)
            accent: Color::Rgb(250, 114, 145),         // Light rose (#FA7291)
            secondary_accent: Color::Rgb(226, 39, 92), // Mascot rose-red (#E2275C)
            text_light: Color::Rgb(253, 246, 227),     // Cream (#FDF6E3)
            text_dark: Color::Rgb(31, 10, 15),         // Deep oxblood (#1F0A0F)
            border: Color::Rgb(90, 58, 66),            // Warm crimson-brown (#5A3A42)
        }
    }
