...
impl Tool for GetGoalTool {
    ...
    fn capabilities(&self, _input: &Value) -> ToolCapabilities {
        serial_goal_capabilities(self.name(), false)
    }
...
impl Tool for CreateGoalTool {
    ...
    fn capabilities(&self, _input: &Value) -> ToolCapabilities {
        serial_goal_capabilities(self.name(), true)
    }
...
fn serial_goal_capabilities(name: &str, mutating: bool) -> ToolCapabilities {
    ...
    if mutating {
        capabilities
            .approval_keys
            .push(ApprovalKey::new("tool", name.to_string()));
    }
    capabilities
}
