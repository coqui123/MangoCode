...
- User:    ~/.mangocode/settings.json
- Project: .mangocode/settings.json
- Local:   .mangocode/settings.local.json
...
Modify MangoCode configuration by updating settings.json files.

## Settings File Locations

| File | Scope | Use For |
|------|-------|---------|
| `~/.mangocode/settings.json` | Global | Personal preferences for all projects |
| `.mangocode/settings.json` | Project | Team-wide hooks, permissions, plugins |
| `.mangocode/settings.local.json` | Project (local) | Personal overrides for this project |
