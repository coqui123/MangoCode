...
impl Tool for EnterPlanModeTool {
    fn name(&self) -> &str {
        mangocode_core::constants::TOOL_NAME_ENTER_PLAN_MODE
    }
...
fn parse_input(input: Value) -> Result<EnterPlanModeInput, String> {
...
mod tests {
    ...
    #[test]
    fn parse_input_rejects_malformed_reason_type() {
        let err = parse_input(json!({ "reason": 42 })).unwrap_err();
