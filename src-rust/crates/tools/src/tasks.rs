...
impl Tool for TaskCreateTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_CREATE }
...
impl Tool for TaskGetTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_GET }
...
impl Tool for TaskUpdateTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_UPDATE }
...
impl Tool for TaskListTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_LIST }
...
impl Tool for TaskStopTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_STOP }
...
impl Tool for TaskOutputTool {
    fn name(&self) -> &str { mangocode_core::constants::TOOL_NAME_TASK_OUTPUT }
