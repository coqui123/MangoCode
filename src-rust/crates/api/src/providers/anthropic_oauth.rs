...
/// Claude Max beta feature flags required for OAuth Bearer authentication.
...
/// - `beta_features` set to the required Claude Max beta flags
...
mod tests {
    ...
    fn test_max_betas_contains_required_features() {
        // Verify MAX_BETAS contains the required OAuth beta flags
